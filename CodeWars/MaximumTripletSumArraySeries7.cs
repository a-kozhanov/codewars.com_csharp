...
https://www.codewars.com/kata/5aa1bcda373c2eb596000112/solutions/csharp
...
namespace CodeWars
{
    public class MaximumTripletSumArraySeries7
    {
        ...
        {
            //return a.Distinct().OrderByDescending(i => i).Take(3).Sum();
            //return a.Distinct().OrderBy(i => i).TakeLast(3).Sum();
