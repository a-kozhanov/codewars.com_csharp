...
https://www.codewars.com/kata/55e6f5e58f7817808e00002e/solutions/csharp
...
namespace CodeWars
{
    public class RuleOfDivisibilityBy7
    {
        ...
        {
            return (m < 99) ? new[] {m, count} : Seven(m / 10 - 2 * (m % 10), ++count);
        ...
        // {
        //     return new[]
        //             {Enumerable.Range(0, 100).TakeWhile(_ => m > 99).Select(_ => m = m / 10 - m % 10 * 2).Count(), m}
        //         .Reverse().ToArray();
        // }
    }
}