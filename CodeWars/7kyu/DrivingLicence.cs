/*
https://www.codewars.com/kata/586a1af1c66d18ad81000134/csharp
...
namespace CodeWars
{
    public class DrivingLicence
    {
        public string driver(params string[] data)
        {
            ...
            // var dt = DateTime.Parse(data[3]);
            // return $"{data[2].PadRight(5, '9')[..5]}{$"{dt:yy}"[0]}{dt.Month + (data[4] == "M" ? 0 : 50):D2}{dt:dd}{$"{dt:yy}"[1]}{data[0][0]}{(data[1] + '9')[..1]}9AA".ToUpper();
        }
    }
}