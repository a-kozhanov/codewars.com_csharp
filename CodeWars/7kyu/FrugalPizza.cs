/*
https://www.codewars.com/kata/58e4fbd63258cefa4100002c/csharp
...
namespace CodeWars
{
    ...
    {
        public static double PizzaPrice(double diameter, double price)
        {
            return Math.Round(price / (Math.Pow(diameter / 2, 2) * Math.PI), 2);
        }
    }
}