/*
https://www.codewars.com/kata/540f8a19a7d43d24ac001018/csharp
...
namespace CodeWars
{
    public class ArithmeticSequence
    {
        ...
        {
            //return Enumerable.Range(first, n).Aggregate(first, (a, b) => a + c);
        ...
        public static int Nthterm(params int[] x)
        {
            return x[0] + x[1] * x[2];
        }
    }
