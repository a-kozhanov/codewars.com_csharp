/*
https://www.codewars.com/kata/52c32ef251f31ae8f50000ae/csharp
...
namespace CodeWars
{
    public class DifferentialAveraging
    {
        public static double AddToAverage(double current, int points, double add)
        {
            //return (points * current + add) / (points + 1);
