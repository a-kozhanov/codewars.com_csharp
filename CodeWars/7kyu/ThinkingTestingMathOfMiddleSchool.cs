/*
https://www.codewars.com/kata/56d9c274c550b4a5c2000d92/csharp
...
namespace CodeWars
{
    public class ThinkingTestingMathOfMiddleSchool
    {
        public int[] Testit(int[] a, int[] b)
        {
            //return Enumerable.Range(0, 4).Select(i => a[i / 2 * 2] * b[i % 2] + a[i / 2 * 2 + 1] * b[i % 2 + 2]).ToArray();
