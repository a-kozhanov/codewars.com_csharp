/*
https://www.codewars.com/kata/606efc6a9409580033837dfb/csharp
...
Notes
Edge conditions will not be tested, meaning parameters of water or fertilizer or temperature being zero. 
This will not be tested. The parameters will always be valid (no zero).
...
namespace CodeWars
{
    public class HarvestFestival
    {
        ...
        {
            // return new StringBuilder(water)
            //     .Insert(0, new string('-', water) + new string(seed, temp >= 20 && temp <= 30 ? fert : 0),
            //         water) + new string(seed, temp >= 20 && temp <= 30 ? 0 : 1);
