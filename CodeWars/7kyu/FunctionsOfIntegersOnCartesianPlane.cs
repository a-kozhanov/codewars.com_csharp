/*
https://www.codewars.com/kata/559e3224324a2b6e66000046/csharp
...
namespace CodeWars
{
    ...
    {
        public static ulong sumin(ulong n) => n * (n + 1) * (2 * n + 1) / 6;

        public static ulong sumax(ulong n) => n * (n + 1) * (4 * n - 1) / 6;

        public static ulong sumsum(ulong n) => n * n * (n + 1);
    }
}