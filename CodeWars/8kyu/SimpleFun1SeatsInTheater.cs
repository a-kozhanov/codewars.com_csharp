...
https://www.codewars.com/kata/588417e576933b0ec9000045/solutions/csharp
...
namespace CodeWars
{
    public class SimpleFun1SeatsInTheater
    {
        ...
        //public static int SeatsInTheater(int nCols, int nRows, int col, int row) => (nRows - row) * (nCols - col + 1);


        //public static int SeatsInTheater(int w, int x, int y, int z)
        //{
        //    return (w-y+1)*(x-z);
        //}
