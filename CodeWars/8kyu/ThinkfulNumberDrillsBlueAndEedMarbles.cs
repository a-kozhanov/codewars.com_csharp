...
namespace CodeWars
{
    public class ThinkfulNumberDrillsBlueAndEedMarbles
    {
        ...
        // public static double GuessBlue(uint blueStart, uint redStart, uint bluePulled, uint redPulled)
        // {
        //     var actualBlue = blueStart - bluePulled;
        //     var actualRed = redStart - redPulled;
        //     return (double) actualBlue / (actualRed + actualBlue);
        // }
    }
}